...
const PostDetail = ({post}) => {
  ...
  const getContentFragment = (index, text, obj, type) => {
    ...
    switch (type) {
      ...
      case 'paragraph':
        return <p key={index} className="mb-8 dark:text-white">{modifiedText.map((item, i) => <React.Fragment key={i}>{item}</React.Fragment>)}</p>;
      case 'heading-four':
  ...
  return (
    ...
    <div className="bg-white dark:bg-black shadow-lg rounded-lg lg:p-8 pb-12 mb-8">
